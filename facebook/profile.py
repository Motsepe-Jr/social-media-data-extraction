...
class Profile:
    ...
    def __init__(self, twitter_username, browser, proxy, posts_count, headless):
        self.__driver = ""
    ...
    def __check_posts_presence(self, posts_list):
        if len(posts_list) <= 0:
            self.retry -= 1
    ...
    def __fetch_and_store_data(self):
        try:
            ...
            present_tweets = Finder.get_all_posts(self.__driver)
...
def scrape_profile(twitter_username: str, browser: str = "firefox", proxy: Union[str, None] = None,
    ...
    """
    print('started scrap...', tweets_count, twitter_username)
